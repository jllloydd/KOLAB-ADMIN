...
<?php include '../layouts/body.php'; ?>
                                ...
                                <div class="card ">
                                    ...
                                    <div class="row approved-item d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="col-1 second-col d-flex flex-column align-items-center">
                                            <img src="../assets/img/booking/term-icon.svg" alt="" width="17" height="17" class="icon-position term-icon">
    ...
    <!-- end row -->
                    ...
                    <!--View Button-->
                    <button type="button" class="btn view-btn" data-bs-toggle="modal" data-bs-target="#myModal">View</button>
